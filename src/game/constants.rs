...
// Terrains
pub const GRASS_LAND_X_OFFSET: f64 = 5f64;
pub const GRASS_LAND_Y_OFFSET: f64 = 9f64;
pub const GRASS_LAND_SIZE: f64 = 16f64;

pub const WOODEN_PATH_X_OFFSET: f64 = 15f64;
pub const WOODEN_PATH_Y_OFFSET: f64 = 18f64;
pub const WOODEN_PATH_SIZE: f64 = 16f64;
